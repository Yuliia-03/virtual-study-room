...
# import User database when it has been made
...
Ideally 'reward_number' will link to the FK reward_id firebase database.
...
class Rewards (models.Model):
    ...
    user = models.ForeignKey(User, on_delete=models.CASCASE) # Link to the user
