...
from .views.spotify_view import AuthURL, spotify_callback, IsAuthenticated, GetAlbumTracks, GetSpotifyToken
...
urlpatterns = [
    ...
    path('api/token/', GetSpotifyToken.as_view(), name='get-token'),
    #path('', include(router.urls)),
